...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? SplashWidget() : StartWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          ...
          path: '/homeClean',
          requireAuth: true,
          builder: (context, params) => HomeCleanWidget(),
        ),
        FFRoute(
          name: 'discover',
          path: '/discover',
  ...
  GoRoute toRoute(AppStateNotifier appStateNotifier) => GoRoute(
        ...
        pageBuilder: (context, state) {
          ...
          final child = appStateNotifier.loading
              ? Container(
                  color: FlutterFlowTheme.of(context).blueblack,
                  child: Center(
                    child: Image.asset(
                      'assets/images/logoapppng.png',
                      width: 100.0,
                      fit: BoxFit.contain,
                    ),
                  ),
